...
public class SpecificPersonOwnPostAdapter extends BaseAdapter {
    ...
    public SpecificPersonOwnPostAdapter(List<UserPost> posts, Context context, UserInfo now_user_info) {
        this.posts = posts;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //看别人的个人信息的时候不能删除别人的帖子
        viewHolder.person_own_post_delete_btn.setVisibility(View.INVISIBLE);
