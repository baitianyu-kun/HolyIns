...
public class PersonOwnForwardPostAdapter extends BaseAdapter {
    ...
    public PersonOwnForwardPostAdapter(List<ForwardUserPost> posts, Context context, UserInfo now_user_info) {
        this.posts = posts;
