...
public class PersonOwnPostAdapterNoHolder extends BaseAdapter {

    public interface RefreshPageListener {
        public void onRefreshPagClick();
    }

    private PersonOwnPostAdapter.RefreshPageListener refreshPageListener;

    public void setOnRefreshPageClickListener(PersonOwnPostAdapter.RefreshPageListener RefreshPageListener) {
    ...
    public PersonOwnPostAdapterNoHolder(List<UserPost> posts, Context context, UserInfo now_user_info) {
        this.posts = posts;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.person_own_post_item_photo.setTag(currentURL);
